    ...
    <div class="w-full flex flex-col p-4 mb-0 bg-white">
        ...
        <div class="w-full flex flex-col mb-4">
            ...
            <div class="w-full flex flex-row gap-3 pt-5">
                <app-button outlined class="!flex-1 !border-2 !border-red-500 !text-red-500 !rounded-full"
                    @click="$emit('ignore', delivery)">
                    Ignore
                </app-button>
                <app-button class="!flex-1 !bg-black !text-white !rounded-full" @click="$emit('accept', delivery)">
                    Take Order
                </app-button>
            </div>
        </div>
