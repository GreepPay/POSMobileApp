          ...
          >
            ...
            >
              ...
              <div class="w-[25%] h-[135px] relative">
                ...
                <!-- Add vote image -->
                <div
                  class="absolute top-0 left-0 w-full h-full px-2 py-2 items-center justify-center flex flex-col"
                >
                  <div
                    :style="`background-image: url(${
                      item.image_url || '/images/profile-image.svg'
                    });  background-size: cover;
    background-repeat: no-repeat;
    background-position: center;`"
                    class="h-[50px] w-[50px] rounded-full flex flex-row items-center relative"
                    v-if="item.is_vote"
                  >
                    <app-file-attachment
                      :is-wrapper="true"
                      ...
                      v-model:cloudFileUrl="item.image_url"
                      autoUploadToCloud
                    >
            ...
            <!-- Enable as vote section -->
            <div class="w-full pt-2 pl-[2px]">
              <app-checkbox v-model="item.is_vote" :variant="'normal'">
                <template #label>
                  <app-normal-text
                  ...
                  >
                    {{
                      item.is_vote
                        ? "Enable this ticket as a voting option"
                        : "Enable this ticket as a voting option"
                    }}
                  </app-normal-text>
                </template>
