                ...
                <div class="w-full flex flex-col items-center justify-start px-4 h-full pt-4">
                    ...
                    <div class="w-full flex flex-col space-y-4">
                        ...
                        <div class="w-full flex flex-col" v-if="showDeliverySelector">
                            <app-select :placeholder="'Select Location Area'" :hasTitle="false" :paddings="'py-4 !px-4'"
                                :options="deliveryLocationOptions" ref="deliveryArea" usePermanentFloatingLabel
